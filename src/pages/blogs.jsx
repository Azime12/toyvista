                ...
                >
                  <div className="relative overflow-hidden h-52">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1 text-xs font-semibold text-white rounded-full bg-gradient-to-r from-[#007BFF]/90 to-[#66CB67]/90">
                        Article
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      to={`/blog/${blog.slug}`}
                      state={{ blog }}
                      className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-white transition-all duration-300 rounded-lg bg-gradient-to-r from-[#007BFF] to-[#66CB67] hover:shadow-lg hover:gap-3"
                    >
                      Read More
