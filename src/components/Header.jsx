...
//           `http://localhost/toyvista/api/search-products.php?q=${encodeURIComponent(searchQuery.trim())}&limit=5`
//         );
...
//           <img src="/images/logo.webp" alt="Toyvista Logo" className="w-auto h-16 " />
//         </Link>
//         </div>
