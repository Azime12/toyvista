...
const TrendingProducts = () => {
  ...
  useEffect(() => {
    const LOCAL_KEY = "trending_products_cache_toyvista";
            ...
            >
              ...
              <div className="flex flex-col flex-grow p-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full px-4 py-2 mt-3 text-xs font-semibold text-center text-blue-600 transition border border-blue-200 rounded-lg hover:bg-blue-50"
                >
                  View Details
                </a>
              </div>
