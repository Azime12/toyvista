      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <div className="w-4 h-1 mx-2 bg-blue-400 rounded-full"></div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {blogPosts.map((post) => (
            <article 
              key={post.id}
              className="overflow-hidden transition-all duration-300 transform bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-2xl hover:-translate-y-2 group"
            >
              {/* Blog Image */}
              ...
              <div className="p-6">
                ...
                {/* Title */}
                <h3 className="mb-3 text-lg font-bold text-gray-900 transition-colors duration-200 line-clamp-2 group-hover:text-blue-600">
                  {post.title}
                </h3>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  ...
                  <a
                    href={`/blog/${post.slug}`}
                    className="inline-flex items-center gap-2 text-sm font-medium text-blue-600 transition-colors duration-200 hover:text-blue-700 group/readmore"
                  >
                    Read More
              ...
              {/* Hover Border Effect */}
              <div className="absolute bottom-0 left-0 w-0 h-1 transition-all duration-500 bg-gradient-to-r from-blue-600 to-purple-600 group-hover:w-full"></div>
            </article>
          ))}
        </div>
        ...
        {/* <div className="mt-12 text-center">
          <a
            href="/blogs"
            className="inline-flex items-center gap-3 px-8 py-4 font-semibold text-blue-600 transition-all duration-200 transform bg-white border border-blue-600 shadow-lg hover:bg-blue-600 hover:text-white rounded-xl hover:shadow-xl hover:scale-105"
          >
